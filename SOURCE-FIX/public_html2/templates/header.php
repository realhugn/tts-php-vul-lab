    ...
    <nav>
        <div class="container">
            <h2 class="log">
                ...
                <a style="text-decoration: none;" href="http://192.168.56.135:2010/index.php">DZ0SA </a>
            </h2>
            <div class="search-bar" style="width:fit-content">
                <i class=" uil uil-search"></i>
                <form name="search" action="http://192.168.56.135:2010/search.php" method="get" style="display: inline-block;">
            ...
            <div class="create">
                ...
                <?php if (isset($_SESSION['loggedin'])) { ?>
                    <a href="http://192.168.56.135:2010/logout.php" class='btn btn-primary' for="createPost" style="color:white;">
                        Logout
                    </a>
                <?php } ?>
            </div>
